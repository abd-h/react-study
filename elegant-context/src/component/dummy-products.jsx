...
export const DUMMY_PRODUCTS = [
  {
    id: "p1",
    image: mochaOvercoat,
    title: "Mejestic Vintage Mocha Overcoat",
    price: 129.99,
    description:
  ...
  },
  {
    ...
    price: 189.99,
    description:
      "Bask in the glow of elegance with our Enchanting Blush Dream Gown. Embody the regality of aqueen with a sweet touch of pink that whispers enchantment. This is the perfect piece for those seeking to create unforgettable moments.",
  },
  {
    id: "p3",
    image: rainJacket,
    ...
    price: 49.99,
    description:
      "Brace the showers in style! Our Vintage Sunshine Rain Jacket ensures that you stand out, even in the dullest weather. Because rain is never a reason to compromise on your fasion quotient.",
  },
  {
    id: "p4",
    image: merlotSuit,
  ...
  },
  {
    id: "p6",
      image: denimPioneer,
    price: 79.99,
    title: " Pioneer Rugged Denim Jacker",
    description:
      "Our Pioneer Ruged Denim Jacket is a tribute to those who embody the spirit of adventure. Designed with durability and comfort in mind, this jacket is wardrobe essential for the urban explorer.",
  },
];